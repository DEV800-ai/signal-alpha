---
signal_id: volume_anomaly_5_60_t2.0__hold20d
status: validated
hold_days: 20
data_sources:
  - db:prices
...
# Volume Anomaly 5 60 T2 0  Hold20D
...
[Run #15](signal_run:15) — 2026-05-06

- N events: **1480** (window 2018-03-28 → 2024-12-24)
- Hit rate: **55.4%**
- Mean return: **+2.79%** over 20 trading days
- Mean alpha vs sector: **+1.42%**
- p-value vs sector: **0.0062** — below the 0.05 bar — **VALIDATED**
- Sharpe (annualized): **0.47**
...
- 2026-05-06 — run_id=15 completed. [Results](signal_run:15). Status: validated.
