---
signal_id: volume_anomaly_5_60_t2.0_ai_infra
status: graveyard
hold_days: 30
data_sources:
  - db:prices
...
# Volume Anomaly 5 60 T2 0 Ai Infra
...
[Run #8](signal_run:8) — 2026-05-06

- N events: **550** (window 2018-03-28 → 2024-12-23)
- Hit rate: **61.5%**
- Mean return: **+4.21%** over 30 trading days
- Mean alpha vs sector: **+0.65%**
- p-value vs sector: **0.2405** — above the 0.05 bar — **NOT VALIDATED**
- Sharpe (annualized): **0.74**
- Max drawdown of sequential equity curve: **-95.9%**
...
- 2026-05-06 — run_id=8 completed. [Results](signal_run:8). Status: graveyard.
