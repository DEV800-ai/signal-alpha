---
signal_id: 8k_excl_earnings__hold5d
status: graveyard
hold_days: 5
data_sources:
  - db:earnings_events
...
[Run #17](signal_run:17) — 2026-05-06

- N events: **3754** (window 2018-01-02 → 2024-12-30)
- Hit rate: **52.5%**
- Mean return: **+0.34%** over 5 trading days
- Mean alpha vs sector: **+0.10%**
- p-value vs sector: **0.2990** — above the 0.05 bar — **NOT VALIDATED**
- Sharpe (annualized): **0.36**
- Max drawdown of sequential equity curve: **-99.6%**
...
- 2026-05-06 — run_id=17 completed. [Results](signal_run:17). Status: graveyard.
