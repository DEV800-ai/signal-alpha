---
signal_id: 8k_excl_earnings__hold10d
status: graveyard
hold_days: 10
data_sources:
  - db:earnings_events
...
[Run #18](signal_run:18) — 2026-05-06

- N events: **3754** (window 2018-01-02 → 2024-12-30)
- Hit rate: **54.0%**
- Mean return: **+0.76%** over 10 trading days
- Mean alpha vs sector: **+0.19%**
- p-value vs sector: **0.1652** — above the 0.05 bar — **NOT VALIDATED**
...
- 2026-05-06 — run_id=18 completed. [Results](signal_run:18). Status: graveyard.
