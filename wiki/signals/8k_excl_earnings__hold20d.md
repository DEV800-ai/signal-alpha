---
signal_id: 8k_excl_earnings__hold20d
status: graveyard
hold_days: 20
data_sources:
  - db:earnings_events
...
[Run #20](signal_run:20) — 2026-05-06

- N events: **3754** (window 2018-01-02 → 2024-12-30)
- Hit rate: **55.1%**
- Mean return: **+1.45%** over 20 trading days
- Mean alpha vs sector: **+0.28%**
- p-value vs sector: **0.1459** — above the 0.05 bar — **NOT VALIDATED**
- Sharpe (annualized): **0.38**
...
- 2026-05-06 — run_id=20 completed. [Results](signal_run:20). Status: graveyard.
